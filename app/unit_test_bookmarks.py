    ...
    def test_bookmarks_jump(self):
        ...
        self.run_with_test_file(
            ...
            [
                ...
                self.write_text("six"),
                CTRL_J,
                self.write_text("seven"),
                CTRL_J,
                self.write_text("eight"),
                CTRL_J,
                CTRL_E,
                "b",
                "m",
                CTRL_J,  # Create a new bookmark.
                self.write_text("nine"),
                CTRL_J,
                self.write_text("ten"),
                CTRL_J,
                self.write_text("eleven"),
                CTRL_J,
                self.write_text("twelve"),
                CTRL_J,
                self.write_text("thirteen"),
                CTRL_J,
                self.write_text("fourteen"),
                CTRL_J,
                self.write_text("fifteen"),
                CTRL_J,
                self.write_text("sixteen"),
                CTRL_J,
                self.write_text("seventeen"),
                CTRL_J,
                self.write_text("eighteen"),
                CTRL_J,
                self.write_text("nineteen"),
                CTRL_J,
                self.write_text("twenty"),
                CTRL_J,
                self.write_text("twenty-one"),
                CTRL_J,
                self.write_text("twenty-two"),
                CTRL_J,
                self.write_text("twenty-three"),
                CTRL_E,
                "b",
                "m",
                CTRL_J,  # Create a new bookmark.
